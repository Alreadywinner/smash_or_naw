      ...
      <div className="flex items-center justify-center p-5">
        ...
        <div className="text-center mr-20">
          ...
          <div className="flex items-center mt-2">
            <label htmlFor="naw1" className="mr-4 flex flex-col gap-2">
              <span>1</span>
              <input type="radio" id="naw1" name="naw" />
            </label>
            <label htmlFor="naw2" className="mr-4 flex flex-col gap-2">
              <span>2</span>
              <input type="radio" id="naw2" name="naw" />
            </label>
            <label htmlFor="naw3" className="flex flex-col gap-2">
              <span>3</span>
        ...
        <div className="text-center mr-20">
          ...
          <div className="flex items-center mt-2">
            <label htmlFor="or1" className="mr-4 flex flex-col gap-2">
              <span>4</span>
              <input type="radio" id="or1" name="or" />
            </label>
            <label htmlFor="or2" className="mr-4 flex flex-col gap-2">
              <span>5</span>
              <input type="radio" id="or2" name="or" />
            </label>
            <label htmlFor="or3" className="flex flex-col gap-2">
              <span>6</span>
        ...
        <div className="text-center mr-20">
          ...
          <div className="flex items-center mt-2">
            <label htmlFor="smash1" className="mr-4 flex flex-col gap-2">
              <span>7</span>
              <input type="radio" id="smash1" name="smash" />
            </label>
            <label htmlFor="smash2" className="mr-4 flex flex-col gap-2">
              <span>8</span>
              <input type="radio" id="smash2" name="smash" />
            </label>
            <label htmlFor="smash3" className="mr-4 flex flex-col gap-2">
              <span>9</span>
              <input type="radio" id="smash3" name="smash" />
            </label>
            <label htmlFor="smash3" className="flex flex-col gap-2">
              <span>10</span>
              <input type="radio" id="smash3" name="smash" />
            </label>
          </div>
